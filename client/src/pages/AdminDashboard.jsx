...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const res = await fetch(`http://localhost:5000/admin/dashboard?username=${username}`);
  ...
  const fetchParticipants = async () => {
    try {
      ...
      const res = await fetch(`http://localhost:5000/admin/participants?username=${username}`);
      const data = await res.json();
  ...
  const fetchAdmins = async () => {
    try {
      ...
      const res = await fetch(`http://localhost:5000/admin/list?username=${username}`);
      const data = await res.json();
  ...
  const grantDashboardAccess = async (adminUsername) => {
    try {
      ...
      const res = await fetch("http://localhost:5000/admin/grant-dashboard-access", {
        method: "POST",
        headers: {
  ...
  const revokeDashboardAccess = async (adminUsername) => {
    try {
      ...
      const res = await fetch("http://localhost:5000/admin/revoke-dashboard-access", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchAllUsers = async () => {
    try {
      ...
      const res = await fetch(`http://localhost:5000/owner/users?username=${username}`);
      const data = await res.json();
  ...
  const grantAdminAccess = async (targetUsername) => {
    try {
      ...
      const res = await fetch("http://localhost:5000/owner/grant-admin", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const revokeAdminAccess = async (targetUsername) => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:5000/owner/revoke-admin", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-10 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        {activeTab === "participants" && (
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
            <h3 className="text-xl font-semibold text-blue-600 mb-4">All Participants</h3>
        ...
        {activeTab === "admins" && (
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Grant or revoke dashboard access for admin users. Only admins with dashboard access can view the admin dashboard.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  ...
                  {admins.map((admin) => (
                    <tr key={admin.username} className="border-b border-blue-100">
                      ...
                      <td className="py-2 px-4">
                        {admin.dashboard_access ? (
                          <button
                            onClick={() => revokeDashboardAccess(admin.username)}
                          ...
                          <button
                            onClick={() => grantDashboardAccess(admin.username)}
